...
// Simple in-memory rate limit per IP to avoid abuse
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Dreamlo delete by name (use HTTP because some boards don't have SSL)
    const url = `http://www.dreamlo.com/lb/${DREAMLO_PRIVATE}/delete/${encoded}`;
